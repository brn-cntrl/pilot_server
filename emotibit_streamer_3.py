...
class EmotiBitStreamer:
    ...
    def generic_handler(self, address: str, *args) -> None:
        ...
        if not hasattr(self, 'current_timestamp') or self.current_timestamp != self.timestamp_manager.get_timestamp():
            self.current_timestamp = self.timestamp_manager.get_timestamp()
    ...
    def calculate_rr(self) -> float:
        ...
        # Bandpass filter
        filtered_signal = self.bandpass_filter(ppg_values, 0.1, 0.5, 100)  # Assuming 25 Hz sampling rate
